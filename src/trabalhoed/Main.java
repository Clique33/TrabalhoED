...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            if(!(temp = leitor.next()).equals("n")) arquivo = temp;
            ...
            try {
                ...
                while(true){
                    ...
                    while(true){
                        ...
                        else System.out.println("Por favor, escolha uma opção válida (s/n)");
                    }
                ...
                if(leitor.next().equals("s")){
                    ...
                    while(true){
                        ...
                        try{
                           ...
                           if(aux >-1 && aux < 3) arv.imprime(aux);
